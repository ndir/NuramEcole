...
public abstract class ITextComponent extends UIComponentBase
{
   ...
   public void addToITextParent(Object obj)
   {
      ...
      if (parent != null)
      {
    	  ...
    	  if (obj instanceof PdfPTable && parent instanceof UIDocument && ((UIDocument) parent).documentType == UIDocument.RTF)
    	  {
    		  UIDocument parentDoc = (UIDocument) parent;
    		 RtfDocument rtfdoc= ((RtfWriter2)parentDoc.getWriter()).getRtfDoc();
    		  
    		  
    		  PdfPTable pTable = (PdfPTable)obj;
    		  
    		  RtfTable table = new RtfTable(rtfdoc,pTable);
    		  
    		 // table.importTable(pTable, 0);
    		  parent.add(table);

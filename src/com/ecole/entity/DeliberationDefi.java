 ...
 */
@Entity
@Table(name = "deliberationdefi")
public class DeliberationDefi implements Serializable {
	...
	private List<NoteDefi> listeNote;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DeliberationDefi other = (DeliberationDefi) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	@JoinColumn(name = "id")
	public List<NoteDefi> getListeNote() {
		return listeNote;
	}

	public void setListeNote(List<NoteDefi> listeNote) {

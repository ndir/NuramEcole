...
@Name("sexeConverter")
public class SexeConverter implements Converter {
	...
	public Object getAsObject(FacesContext myContextFaces, UIComponent pComponent, String pValeur) {
		Lst_Sexe sexe = (Lst_Sexe)this.dataSource.get(Lst_Sexe.class, 
				new Long(pValeur));
		return sexe;
	}
	/**
	...
	public String getAsString(FacesContext myContextFaces, UIComponent uiComponent, Object objet) {
		Lst_Sexe sexe = (Lst_Sexe)objet;
		String resultat = "";
		if (sexe != null) {
			resultat = sexe.getIdSexe().toString();
		}
		return resultat;
	}
}

...
public class TypeAbsenceConverter implements Converter {
	...
	public Object getAsObject(FacesContext myContextFaces, UIComponent pComponent, String pValeur) {
		Lst_TypeAbsence typeAbsence = (Lst_TypeAbsence)this.dataSource.get(Lst_TypeAbsence.class, 
				new Long(pValeur));
		return typeAbsence;
	}
	/**
	...
	public String getAsString(FacesContext myContextFaces, UIComponent uiComponent, Object objet) {
		Lst_TypeAbsence typeAbsence = (Lst_TypeAbsence)objet;
		String resultat = "";
		if (typeAbsence != null) {
			resultat = typeAbsence.getIdTypeAbsence().toString();
		}
		return resultat;
	}
}

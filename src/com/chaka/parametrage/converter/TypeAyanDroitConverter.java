...
@Name("typeAyantDroitConverter")
public class TypeAyanDroitConverter implements Converter {
	...
	public Object getAsObject(FacesContext myContextFaces, UIComponent pComponent, String pValeur) {
		Lst_TypeAyantDroit TypeAyantDroit = (Lst_TypeAyantDroit)this.dataSource.get(Lst_TypeAyantDroit.class, 
				new Long(pValeur));
	...
	public String getAsString(FacesContext myContextFaces, UIComponent uiComponent, Object objet) {
		Lst_TypeAyantDroit TypeAyantDroit = (Lst_TypeAyantDroit)objet;
		String resultat = "";
		if (TypeAyantDroit != null) {
			resultat = TypeAyantDroit.getIdTypeAyantDroit().toString();
		}
		return resultat;
	}
}
